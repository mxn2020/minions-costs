...
/**
 * @minions-costs/cli — CLI for Minions costs
 *
...
import { customTypes } from '@minions-costs/sdk';
...
program.name('costs').description('Cost tracking, budgets, and financial ledgers for agent operations').version('0.1.0');

program.command('info').description('Show project info').action(() => {
    console.log(chalk.bold('Minions costs'));
    console.log(chalk.dim('Cost tracking, budgets, and financial ledgers for agent operations'));
    console.log('');
    console.log(`  SDK:    ${chalk.cyan('@minions-costs/sdk')}`);
    console.log(`  CLI:    ${chalk.cyan('@minions-costs/cli')}`);
    console.log(`  Python: ${chalk.cyan('minions_costs')}`);
