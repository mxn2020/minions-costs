# Contributing to Minions Costs

Thank you for your interest in contributing to Minions Costs!

## Getting Started

1. Fork the repository
2. Clone your fork: `git clone https://github.com/YOUR_USERNAME/minions-costs.git`
