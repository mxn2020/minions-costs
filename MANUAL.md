# Manual Setup Steps for Minions Costs
...
Go to **GitHub → mxn2020/minions-costs → Settings → Secrets and variables → Actions** and add:

| Secret | Description | Where to get it |
|--------|-------------|-----------------|
| `NPM_TOKEN` | npm publish token | [npmjs.com → Access Tokens](https://www.npmjs.com/settings/~/tokens) |
| `PYPI_TOKEN` | PyPI API token for `minions-costs` | [pypi.org → Account Settings → API tokens](https://pypi.org/manage/account/#api-tokens) |
...
### Web App (Playground)
- **Netlify site name**: `minions-costs-web`
- **GitHub repo**: `mxn2020/minions-costs`
- **Base directory**: `apps/web`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/web/dist`
- **Custom domain**: `costs.minions.wtf`

### Documentation
- **Netlify site name**: `minions-costs-docs`
- **GitHub repo**: `mxn2020/minions-costs`
- **Base directory**: `apps/docs`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/docs/dist`
- **Custom domain**: `costs.minions.help`

### Blog
- **Netlify site name**: `minions-costs-blog`
- **GitHub repo**: `mxn2020/minions-costs`
- **Base directory**: `apps/blog`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/blog/dist`
- **Custom domain**: `costs.minions.blog`
...
|--------|------|------|-------|
| Docs | CNAME | `costs.minions.help` | _(Netlify subdomain)_ |
| Blog | CNAME | `costs.minions.blog` | _(Netlify subdomain)_ |
| App  | CNAME | `costs.minions.wtf` | _(Netlify subdomain)_ |
...
Your packages:
- SDK: [`@minions-costs/sdk`](https://www.npmjs.com/package/@minions-costs/sdk)
- CLI: [`@minions-costs/cli`](https://www.npmjs.com/package/@minions-costs/cli)
...
Your package: [`minions-costs`](https://pypi.org/project/minions-costs/)
...
| Item | Value |
|------|-------|
| Project | `minions-costs` |
| SDK (npm) | `@minions-costs/sdk` |
| CLI (npm) | `@minions-costs/cli` |
| Python (PyPI) | `minions-costs` |
| GitHub | `github.com/mxn2020/minions-costs` |
| Docs domain | `costs.minions.help` |
| Blog domain | `costs.minions.blog` |
| App domain | `costs.minions.wtf` |
